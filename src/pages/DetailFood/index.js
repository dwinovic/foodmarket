      ...
      <View style={styles.content}>
        <View>
          <View style={styles.headingProduct}>
            <View>
              <Text style={styles.titleProduct}>Pecel Madiun</Text>
              <Rating rating={4} />
            </View>
            <Counter count={14} />
          </View>
          <Text style={styles.paragprah}>
            Makanan khas Kota Madiun dengan cita rasa yang tinggi dan memiliki
            khasiat yang baik bagi tubuh karena menggunakan kulupan yang sehat
            dan segar
          </Text>
        ...
        <View style={styles.footer}>
          ...
          <View style={{width: 160}}>
            <Button
              title="Order Now"
              onPress={() => navigation.navigate('PaymentProduct')}
            />
          </View>
        </View>
      </View>
